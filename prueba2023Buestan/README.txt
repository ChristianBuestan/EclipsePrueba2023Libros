...
a persistence unit "prueba2023BuestanPersistenceUnit" which uses the JakartaEE default database.
...
In case you don't want to use JSF, simply delete this file and "src/main/webapp/beans.xml" and "src/main/java/ups/edu/ec/prueba2023Buestan/Jsf23Activator.java"
==========================

Testing:
This sample is prepared for running unit tests with the Arquillian framework.

The configuration can be found in "prueba2023Buestan/pom.xml":
...
artifact ("prueba2023Buestan.war") is already built. You can build
